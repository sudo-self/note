...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getCookie, deleteCookie, setCookie, getQuery as getQuery$1, useSession, removeResponseHeader, handleCors, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, sendNoContent, assertMethod, readFormData, setHeader, getValidatedRouterParams, getHeader, getValidatedQuery, getRequestWebStream, readValidatedBody, getResponseStatusText } from 'file:///Users/midnight/note/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join as join$1 } from 'node:path';
import crypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/midnight/note/node_modules/.pnpm/@vue+shared@3.5.21/node_modules/@vue/shared/dist/shared.cjs.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///Users/midnight/note/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/midnight/note/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { ofetch, FetchError, $fetch as $fetch$1, createFetch, Headers as Headers$1 } from 'file:///Users/midnight/note/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { snakeCase, upperFirst } from 'file:///Users/midnight/note/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getRandomValues, randomUUID } from 'file:///Users/midnight/note/node_modules/.pnpm/uncrypto@0.1.3/node_modules/uncrypto/dist/crypto.node.mjs';
import { and, eq, sql } from 'file:///Users/midnight/note/node_modules/.pnpm/drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0/node_modules/drizzle-orm/index.js';
import { useValidatedParams, zh, useValidatedBody, z } from 'file:///Users/midnight/note/node_modules/.pnpm/h3-zod@0.5.3_h3@1.15.4_zod@3.25.76/node_modules/h3-zod/dist/index.mjs';
import { drizzle } from 'file:///Users/midnight/note/node_modules/.pnpm/drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0/node_modules/drizzle-orm/d1/index.js';
import { sqliteTable, integer, text } from 'file:///Users/midnight/note/node_modules/.pnpm/drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0/node_modules/drizzle-orm/sqlite-core/index.js';
import { createStorage, prefixStorage } from 'file:///Users/midnight/note/node_modules/.pnpm/unstorage@1.17.1_db0@0.3.2_drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0___ioredis@5.7.0/node_modules/unstorage/dist/index.mjs';
import httpDriver from 'file:///Users/midnight/note/node_modules/.pnpm/unstorage@1.17.1_db0@0.3.2_drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0___ioredis@5.7.0/node_modules/unstorage/drivers/http.mjs';
import cloudflareKVBindingDriver from 'file:///Users/midnight/note/node_modules/.pnpm/unstorage@1.17.1_db0@0.3.2_drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0___ioredis@5.7.0/node_modules/unstorage/drivers/cloudflare-kv-binding.mjs';
import mime from 'file:///Users/midnight/note/node_modules/.pnpm/mime@4.0.7/node_modules/mime/dist/src/index.js';
import { z as z$1 } from 'file:///Users/midnight/note/node_modules/.pnpm/zod@3.25.76/node_modules/zod/index.js';
import { join, dirname as dirname$1, resolve as resolve$1, basename, parse } from 'file:///Users/midnight/note/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/midnight/note/node_modules/.pnpm/vue-bundle-renderer@2.1.2/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///Users/midnight/note/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/midnight/note/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/midnight/note/node_modules/.pnpm/node-mock-http@1.0.3/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/midnight/note/node_modules/.pnpm/unstorage@1.17.1_db0@0.3.2_drizzle-orm@0.44.2_@cloudflare+workers-types@4.20250905.0___ioredis@5.7.0/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/midnight/note/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/midnight/note/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file:///Users/midnight/note/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/midnight/note/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/midnight/note/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/midnight/note/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/midnight/note/node_modules/.pnpm/youch@4.1.0-beta.8/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/midnight/note/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { stringify, uneval } from 'file:///Users/midnight/note/node_modules/.pnpm/devalue@5.3.2/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/midnight/note/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/midnight/note/node_modules/.pnpm/vue@3.5.21_typescript@5.9.2/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { getIcons } from 'file:///Users/midnight/note/node_modules/.pnpm/@iconify+utils@2.3.0/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/midnight/note/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/midnight/note/node_modules/.pnpm/unhead@2.0.14/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/midnight/note/node_modules/.pnpm/vue@3.5.21_typescript@5.9.2/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/midnight/note/node_modules/.pnpm/unhead@2.0.14/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/midnight/note/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/midnight/note","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/midnight/note/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/midnight/note/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/midnight/note/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/midnight/note/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "hub": {
    ...
    "projectKey": "",
    "userToken": "user_toi5Wjhbrqw2eiohukDoZarRFZvV6g",
    "remote": "",
    "remoteManifest": "",
    "dir": "/Users/midnight/note/.data/hub",
    "workers": "",
    "ai": false,
    "analytics": false,
    "blob": false,
    ...
    "databaseMigrationsDirs": [
      "/Users/midnight/note/server/database/migrations"
    ],
  ...
  "wrangler": {
    "configPath": "/Users/midnight/note/.data/hub/wrangler.toml",
    "persistDir": "/Users/midnight/note/.data/hub"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const _MkFRLsI_vWC7Tnhp9hIysilt5zFuO3I64U7CMRBFRk = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/midnight/note";
...
const _x0CbNJc66B2_QUDQFU9GuUUizhaHwWirI3ih4KBNqSE = (nitroApp) => {
...
const _ADfmzYNJ30lILsJ4kE4t24eB3TF4kfZr9yuYpXf81oo = defineNitroPlugin(async () => {
  await globalThis.__env__;
  await hubHooks.callHookParallel("bindings:ready");
});

const _kYzFVyWMQ5G3u2iza_2rn3Z9fXVuEcXOeJxtTdQ8YjI = defineNitroPlugin((nitroApp) => {
...
const _rKbNHGeBSsVtvqRhZ8K6Xxk2_FbaKkZwdIQmuv11gJA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const _OQR8WnwzDd6sWrcu3aP73e9ZTaCuwmp9MmsBJ5kv_s = defineNitroPlugin(async () => {
  const hub = useRuntimeConfig().hub;
...
const _eYNKnigXDsNviu6gaASopXx846NdLIz2y0ckTdpxNA = (function(nitroApp) {
...
const plugins = [
  _MkFRLsI_vWC7Tnhp9hIysilt5zFuO3I64U7CMRBFRk,
_x0CbNJc66B2_QUDQFU9GuUUizhaHwWirI3ih4KBNqSE,
_ADfmzYNJ30lILsJ4kE4t24eB3TF4kfZr9yuYpXf81oo,
_kYzFVyWMQ5G3u2iza_2rn3Z9fXVuEcXOeJxtTdQ8YjI,
_rKbNHGeBSsVtvqRhZ8K6Xxk2_FbaKkZwdIQmuv11gJA,
_OQR8WnwzDd6sWrcu3aP73e9ZTaCuwmp9MmsBJ5kv_s,
_eYNKnigXDsNviu6gaASopXx846NdLIz2y0ckTdpxNA
];
...
const _EPQnlo = eventHandler((event) => {
...
const _ZqZMUp = defineCachedEventHandler(async (event) => {
...
const _9ng7HR = eventHandler((event) => {
  handleCors(event, {
    methods: "*",
    origin: [
...
const _tcHody = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _eY0FHg = eventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/midnight/note/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/midnight/note/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_3NDyFm = () => Promise.resolve().then(function () { return github_get$1; });
const _lazy_NT_4T0 = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_aOl8_8 = () => Promise.resolve().then(function () { return _id__patch$1; });
const _lazy_GFL70s = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_rHk30M = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_r75UCo = () => Promise.resolve().then(function () { return stats$1; });
const _lazy_IFPvJX = () => Promise.resolve().then(function () { return ____feature_$1; });
const _lazy_S8lHAR = () => Promise.resolve().then(function () { return index_head$1; });
const _lazy_b4mZPp = () => Promise.resolve().then(function () { return manifest_get$1; });
const _lazy_hK6k_P = () => Promise.resolve().then(function () { return syncVariables_post$1; });
const _lazy_81oksX = () => Promise.resolve().then(function () { return _command__post$1; });
const _lazy_6iJDEd = () => Promise.resolve().then(function () { return query_options$1; });
const _lazy_qnxITV = () => Promise.resolve().then(function () { return query_post$1; });
const _lazy_1vOHY3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _EPQnlo, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/github', handler: _lazy_3NDyFm, lazy: true, middleware: false, method: "get" },
  { route: '/api/todos/:id', handler: _lazy_NT_4T0, lazy: true, middleware: false, method: "delete" },
  { route: '/api/todos/:id', handler: _lazy_aOl8_8, lazy: true, middleware: false, method: "patch" },
  { route: '/api/todos', handler: _lazy_GFL70s, lazy: true, middleware: false, method: "get" },
  { route: '/api/todos', handler: _lazy_rHk30M, lazy: true, middleware: false, method: "post" },
  { route: '/api/todos/stats', handler: _lazy_r75UCo, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub/**:feature', handler: _lazy_IFPvJX, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _lazy_S8lHAR, lazy: true, middleware: false, method: "head" },
  { route: '/api/_hub/manifest', handler: _lazy_b4mZPp, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/sync-variables', handler: _lazy_hK6k_P, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/database/:command', handler: _lazy_81oksX, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/database/query', handler: _lazy_6iJDEd, lazy: true, middleware: false, method: "options" },
  { route: '/api/_hub/database/query', handler: _lazy_qnxITV, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_1vOHY3, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _ZqZMUp, lazy: false, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _9ng7HR, lazy: false, middleware: true, method: undefined },
  { route: '/api/_auth/session', handler: _tcHody, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _eY0FHg, lazy: false, middleware: false, method: "get" },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_1vOHY3, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1vOHY3, lazy: true, middleware: false, method: undefined }
];
...
const stats = eventHandler(async () => {
  return await useDB().select({
    todos: sql`count(*)`,
    users: sql`count(distinct(${tables.todos.userId}))`
